...
public class StyleUtils {
     ...
     * @param style 样式对象
     */
    public static void styleCell(NiceXSSFWorkbook workbook, XSSFCell cell, Style style) {
        ...
        if (null == cellStyle) {
            ...
            if (null == style.getForegroundColor()) {
                ...
                cellStyle.setFillPattern(oldCellStyle.getFillPatternEnum());
            } else {
            ...
            if (null == style.getHorizontalAlignment()) {
                cellStyle.setAlignment(oldCellStyle.getAlignmentEnum());
            } else {
                cellStyle.setAlignment(style.getHorizontalAlignment());
            }
            if (null == style.getVerticalAlignment()) {
                cellStyle.setVerticalAlignment(oldCellStyle.getVerticalAlignmentEnum());
            } else {
            ...
            if (null == style.getLeftBorderStyle()) {
                cellStyle.setBorderLeft(oldCellStyle.getBorderLeftEnum());
            } else {
            ...
            if (null == style.getTopBorderStyle()) {
                cellStyle.setBorderTop(oldCellStyle.getBorderTopEnum());
            } else {
            ...
            if (null == style.getRightBorderStyle()) {
                cellStyle.setBorderRight(oldCellStyle.getBorderRightEnum());
            } else {
            ...
            if (null == style.getBottomBorderStyle()) {
                cellStyle.setBorderBottom(oldCellStyle.getBorderBottomEnum());
            } else {
        ...
        //设置样式
        CellRangeAddress cellAddresses = workbook.getCellRangeAddress(cell);
    ...
    public static void styleCell(XSSFTemplate template, XSSFCell cell, Style style) {
        styleCell(template.getXSSFWorkbook(), cell, style);
    }
     ...
     * @param styles
     */
    public static void styleCell(NiceXSSFWorkbook workbook, XSSFCell cell, Style... styles) {
        if (null == cell || null == styles || styles.length <= 0) return;
        for (Style style : styles) {
            styleCell(workbook, cell, style);
        }
    }
