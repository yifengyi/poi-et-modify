...
public class CellRenderData {
    ...
    public static CellRenderData build(TextRenderData textRenderData) {
        return new CellRenderData(textRenderData);
    }

    public static CellRenderData build(String text) {
        return new CellRenderData(text);
    }

    public static CellRenderData build(TextRenderData renderData, int rowspan, int colspan) {
        return new CellRenderData(renderData, rowspan, colspan);
    }

    public static CellRenderData build(String text, int rowspan, int colspan) {
        TextRenderData renderData = new TextRenderData(text);
        return new CellRenderData(renderData, rowspan, colspan);
    }
